...
def main(cmd):
    ...
    print(tfprocess.net)
    print(tfprocess.model)
    tfprocess.model.save("/home/pafrank/coding/export-lc0/tf/weights/keras_export.h5", save_format="h5", save_traces=True)
...
if __name__ == "__main__":
    ...
    argparser.add_argument('--cfg',
                           ...
                           default=open("/home/pafrank/coding/export-lc0/tf/configs/config.yaml","r"),
                           help='yaml configuration with training parameters')
    argparser.add_argument('--output',
                           type=str,
                           default="/home/pafrank/coding/export-lc0/tf/weights/",
